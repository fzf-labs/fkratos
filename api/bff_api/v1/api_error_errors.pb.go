...
func IsNotLoggedIn(err error) bool {
	...
	return e.Reason == ApiErrorReason_NOT_LOGGED_IN.String() && e.Code == 401
}

// 401
func ErrorNotLoggedIn(format string, args ...interface{}) *errors.Error {
	return errors.New(401, ApiErrorReason_NOT_LOGGED_IN.String(), fmt.Sprintf(format, args...))
}
...
func IsAccessForbidden(err error) bool {
	...
	e := errors.FromError(err)
	return e.Reason == ApiErrorReason_ACCESS_FORBIDDEN.String() && e.Code == 403
}

// 403
func ErrorAccessForbidden(format string, args ...interface{}) *errors.Error {
	return errors.New(403, ApiErrorReason_ACCESS_FORBIDDEN.String(), fmt.Sprintf(format, args...))
}
...
func IsResourceNotFound(err error) bool {
	...
	e := errors.FromError(err)
	return e.Reason == ApiErrorReason_RESOURCE_NOT_FOUND.String() && e.Code == 404
}

// 404
func ErrorResourceNotFound(format string, args ...interface{}) *errors.Error {
	return errors.New(404, ApiErrorReason_RESOURCE_NOT_FOUND.String(), fmt.Sprintf(format, args...))
}
...
func IsNetworkError(err error) bool {
	...
	e := errors.FromError(err)
	return e.Reason == ApiErrorReason_NETWORK_ERROR.String() && e.Code == 502
}

// 502
func ErrorNetworkError(format string, args ...interface{}) *errors.Error {
	return errors.New(502, ApiErrorReason_NETWORK_ERROR.String(), fmt.Sprintf(format, args...))
}
...
func IsNetworkTimeout(err error) bool {
	...
	e := errors.FromError(err)
	return e.Reason == ApiErrorReason_NETWORK_TIMEOUT.String() && e.Code == 504
}

// 504
func ErrorNetworkTimeout(format string, args ...interface{}) *errors.Error {
	return errors.New(504, ApiErrorReason_NETWORK_TIMEOUT.String(), fmt.Sprintf(format, args...))
}
...
func IsRequestNotSupport(err error) bool {
	...
	e := errors.FromError(err)
	return e.Reason == ApiErrorReason_REQUEST_NOT_SUPPORT.String() && e.Code == 505
}

// 505
func ErrorRequestNotSupport(format string, args ...interface{}) *errors.Error {
	return errors.New(505, ApiErrorReason_REQUEST_NOT_SUPPORT.String(), fmt.Sprintf(format, args...))
}
...
func IsUserNotFound(err error) bool {
	...
	e := errors.FromError(err)
	return e.Reason == ApiErrorReason_USER_NOT_FOUND.String() && e.Code == 600
}

func ErrorUserNotFound(format string, args ...interface{}) *errors.Error {
	return errors.New(600, ApiErrorReason_USER_NOT_FOUND.String(), fmt.Sprintf(format, args...))
}
...
func IsIncorrectPassword(err error) bool {
	...
	e := errors.FromError(err)
	return e.Reason == ApiErrorReason_INCORRECT_PASSWORD.String() && e.Code == 599
}

func ErrorIncorrectPassword(format string, args ...interface{}) *errors.Error {
	return errors.New(599, ApiErrorReason_INCORRECT_PASSWORD.String(), fmt.Sprintf(format, args...))
}
...
func IsUserFreeze(err error) bool {
	...
	e := errors.FromError(err)
	return e.Reason == ApiErrorReason_USER_FREEZE.String() && e.Code == 598
}

func ErrorUserFreeze(format string, args ...interface{}) *errors.Error {
	return errors.New(598, ApiErrorReason_USER_FREEZE.String(), fmt.Sprintf(format, args...))
}
...
func IsInvalidUserid(err error) bool {
	...
	e := errors.FromError(err)
	return e.Reason == ApiErrorReason_INVALID_USERID.String() && e.Code == 101
}

// 用户ID无效
func ErrorInvalidUserid(format string, args ...interface{}) *errors.Error {
	return errors.New(101, ApiErrorReason_INVALID_USERID.String(), fmt.Sprintf(format, args...))
}
...
func IsInvalidPassword(err error) bool {
	...
	e := errors.FromError(err)
	return e.Reason == ApiErrorReason_INVALID_PASSWORD.String() && e.Code == 102
}

// 密码无效
func ErrorInvalidPassword(format string, args ...interface{}) *errors.Error {
	return errors.New(102, ApiErrorReason_INVALID_PASSWORD.String(), fmt.Sprintf(format, args...))
}
...
func IsTokenExpired(err error) bool {
	...
	e := errors.FromError(err)
	return e.Reason == ApiErrorReason_TOKEN_EXPIRED.String() && e.Code == 103
}

// token过期
func ErrorTokenExpired(format string, args ...interface{}) *errors.Error {
	return errors.New(103, ApiErrorReason_TOKEN_EXPIRED.String(), fmt.Sprintf(format, args...))
}
...
func IsInvalidToken(err error) bool {
	...
	e := errors.FromError(err)
	return e.Reason == ApiErrorReason_INVALID_TOKEN.String() && e.Code == 104
}

// token无效
func ErrorInvalidToken(format string, args ...interface{}) *errors.Error {
	return errors.New(104, ApiErrorReason_INVALID_TOKEN.String(), fmt.Sprintf(format, args...))
}
...
func IsTokenNotExist(err error) bool {
	...
	e := errors.FromError(err)
	return e.Reason == ApiErrorReason_TOKEN_NOT_EXIST.String() && e.Code == 105
}

// token不存在
func ErrorTokenNotExist(format string, args ...interface{}) *errors.Error {
	return errors.New(105, ApiErrorReason_TOKEN_NOT_EXIST.String(), fmt.Sprintf(format, args...))
}
...
func IsUserNotExist(err error) bool {
	...
	e := errors.FromError(err)
	return e.Reason == ApiErrorReason_USER_NOT_EXIST.String() && e.Code == 106
}

// 用户不存在
func ErrorUserNotExist(format string, args ...interface{}) *errors.Error {
	return errors.New(106, ApiErrorReason_USER_NOT_EXIST.String(), fmt.Sprintf(format, args...))
}
