...
const (
	Role_SysRoleList_FullMethodName   = "/api.user.v1.Role/SysRoleList"
	Role_SysRoleInfo_FullMethodName   = "/api.user.v1.Role/SysRoleInfo"
	Role_SysRoleStore_FullMethodName  = "/api.user.v1.Role/SysRoleStore"
	Role_SysRoleDel_FullMethodName    = "/api.user.v1.Role/SysRoleDel"
	Role_SysRoleStatus_FullMethodName = "/api.user.v1.Role/SysRoleStatus"
)
