...
const (
	Permission_SysPermissionList_FullMethodName   = "/api.user.v1.Permission/SysPermissionList"
	Permission_SysPermissionInfo_FullMethodName   = "/api.user.v1.Permission/SysPermissionInfo"
	Permission_SysPermissionStore_FullMethodName  = "/api.user.v1.Permission/SysPermissionStore"
	Permission_SysPermissionDel_FullMethodName    = "/api.user.v1.Permission/SysPermissionDel"
	Permission_SysPermissionStatus_FullMethodName = "/api.user.v1.Permission/SysPermissionStatus"
)
