...
const (
	Job_SysJobList_FullMethodName  = "/api.user.v1.Job/SysJobList"
	Job_SysJobInfo_FullMethodName  = "/api.user.v1.Job/SysJobInfo"
	Job_SysJobStore_FullMethodName = "/api.user.v1.Job/SysJobStore"
	Job_SysJobDel_FullMethodName   = "/api.user.v1.Job/SysJobDel"
)
