...
const (
	Auth_SysAuthLoginCaptcha_FullMethodName = "/api.user.v1.Auth/SysAuthLoginCaptcha"
	Auth_SysAuthLogin_FullMethodName        = "/api.user.v1.Auth/SysAuthLogin"
	Auth_SysAuthLogout_FullMethodName       = "/api.user.v1.Auth/SysAuthLogout"
)
