...
import (
	"context"
	"fkratos/app/rpc/user/internal/data/gorm/usermodel"
...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.userDo.UseModel(&usermodel.User{})
...
func (u userDo) Create(values ...*usermodel.User) error {
	if len(values) == 0 {
		return nil
	}
...
func (u userDo) CreateInBatches(values []*usermodel.User, batchSize int) error {
	return u.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (u userDo) Save(values ...*usermodel.User) error {
	if len(values) == 0 {
		return nil
	}
...
func (u userDo) First() (*usermodel.User, error) {
	if result, err := u.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*usermodel.User), nil
	}
}

func (u userDo) Take() (*usermodel.User, error) {
...
func (u userDo) Last() (*usermodel.User, error) {
...
func (u userDo) Find() ([]*usermodel.User, error) {
	result, err := u.DO.Find()
	return result.([]*usermodel.User), err
}

func (u userDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*usermodel.User, err error) {
	buf := make([]*usermodel.User, 0, batchSize)
...
func (u userDo) FindInBatches(result *[]*usermodel.User, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (u userDo) FirstOrInit() (*usermodel.User, error) {
...
func (u userDo) FirstOrCreate() (*usermodel.User, error) {
...
func (u userDo) FindByPage(offset int, limit int) (result []*usermodel.User, count int64, err error) {
...
func (u userDo) Delete(models ...*usermodel.User) (result gen.ResultInfo, err error) {
