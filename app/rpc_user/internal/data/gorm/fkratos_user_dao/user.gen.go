...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.userDo.UseModel(&fkratos_user_model.User{})
...
func (u userDo) Create(values ...*fkratos_user_model.User) error {
	if len(values) == 0 {
		return nil
	}
...
func (u userDo) CreateInBatches(values []*fkratos_user_model.User, batchSize int) error {
	return u.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (u userDo) Save(values ...*fkratos_user_model.User) error {
	if len(values) == 0 {
		return nil
	}
...
func (u userDo) First() (*fkratos_user_model.User, error) {
	if result, err := u.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*fkratos_user_model.User), nil
	}
}

func (u userDo) Take() (*fkratos_user_model.User, error) {
...
func (u userDo) Last() (*fkratos_user_model.User, error) {
...
func (u userDo) Find() ([]*fkratos_user_model.User, error) {
	result, err := u.DO.Find()
	return result.([]*fkratos_user_model.User), err
}

func (u userDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*fkratos_user_model.User, err error) {
	buf := make([]*fkratos_user_model.User, 0, batchSize)
...
func (u userDo) FindInBatches(result *[]*fkratos_user_model.User, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (u userDo) FirstOrInit() (*fkratos_user_model.User, error) {
...
func (u userDo) FirstOrCreate() (*fkratos_user_model.User, error) {
...
func (u userDo) FindByPage(offset int, limit int) (result []*fkratos_user_model.User, count int64, err error) {
...
func (u userDo) Delete(models ...*fkratos_user_model.User) (result gen.ResultInfo, err error) {
