...
func newSysDict(db *gorm.DB, opts ...gen.DOOption) sysDict {
	...
	_sysDict.sysDictDo.UseModel(&rpc_sys_model.SysDict{})
...
func (s sysDictDo) Create(values ...*rpc_sys_model.SysDict) error {
	if len(values) == 0 {
		return nil
	}
...
func (s sysDictDo) CreateInBatches(values []*rpc_sys_model.SysDict, batchSize int) error {
	return s.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (s sysDictDo) Save(values ...*rpc_sys_model.SysDict) error {
	if len(values) == 0 {
		return nil
	}
...
func (s sysDictDo) First() (*rpc_sys_model.SysDict, error) {
	if result, err := s.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*rpc_sys_model.SysDict), nil
	}
}

func (s sysDictDo) Take() (*rpc_sys_model.SysDict, error) {
...
func (s sysDictDo) Last() (*rpc_sys_model.SysDict, error) {
...
func (s sysDictDo) Find() ([]*rpc_sys_model.SysDict, error) {
	result, err := s.DO.Find()
	return result.([]*rpc_sys_model.SysDict), err
}

func (s sysDictDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*rpc_sys_model.SysDict, err error) {
	buf := make([]*rpc_sys_model.SysDict, 0, batchSize)
...
func (s sysDictDo) FindInBatches(result *[]*rpc_sys_model.SysDict, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (s sysDictDo) FirstOrInit() (*rpc_sys_model.SysDict, error) {
...
func (s sysDictDo) FirstOrCreate() (*rpc_sys_model.SysDict, error) {
...
func (s sysDictDo) FindByPage(offset int, limit int) (result []*rpc_sys_model.SysDict, count int64, err error) {
...
func (s sysDictDo) Delete(models ...*rpc_sys_model.SysDict) (result gen.ResultInfo, err error) {
