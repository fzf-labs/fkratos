...
func newSysLog(db *gorm.DB, opts ...gen.DOOption) sysLog {
	...
	_sysLog.sysLogDo.UseModel(&rpc_sys_model.SysLog{})
...
func (s sysLogDo) Exists(subquery interface{ UnderlyingDB() *gorm.DB }) *sysLogDo {
...
func (s sysLogDo) Create(values ...*rpc_sys_model.SysLog) error {
	if len(values) == 0 {
		return nil
	}
...
func (s sysLogDo) CreateInBatches(values []*rpc_sys_model.SysLog, batchSize int) error {
	return s.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (s sysLogDo) Save(values ...*rpc_sys_model.SysLog) error {
	if len(values) == 0 {
		return nil
	}
...
func (s sysLogDo) First() (*rpc_sys_model.SysLog, error) {
	if result, err := s.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*rpc_sys_model.SysLog), nil
	}
}

func (s sysLogDo) Take() (*rpc_sys_model.SysLog, error) {
...
func (s sysLogDo) Last() (*rpc_sys_model.SysLog, error) {
...
func (s sysLogDo) Find() ([]*rpc_sys_model.SysLog, error) {
	result, err := s.DO.Find()
	return result.([]*rpc_sys_model.SysLog), err
}

func (s sysLogDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*rpc_sys_model.SysLog, err error) {
	buf := make([]*rpc_sys_model.SysLog, 0, batchSize)
...
func (s sysLogDo) FindInBatches(result *[]*rpc_sys_model.SysLog, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (s sysLogDo) FirstOrInit() (*rpc_sys_model.SysLog, error) {
...
func (s sysLogDo) FirstOrCreate() (*rpc_sys_model.SysLog, error) {
...
func (s sysLogDo) FindByPage(offset int, limit int) (result []*rpc_sys_model.SysLog, count int64, err error) {
...
func (s sysLogDo) Delete(models ...*rpc_sys_model.SysLog) (result gen.ResultInfo, err error) {
