...
func newSysAdmin(db *gorm.DB, opts ...gen.DOOption) sysAdmin {
	...
	_sysAdmin.sysAdminDo.UseModel(&rpc_sys_model.SysAdmin{})
...
func (s sysAdminDo) Create(values ...*rpc_sys_model.SysAdmin) error {
	if len(values) == 0 {
		return nil
	}
...
func (s sysAdminDo) CreateInBatches(values []*rpc_sys_model.SysAdmin, batchSize int) error {
	return s.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (s sysAdminDo) Save(values ...*rpc_sys_model.SysAdmin) error {
	if len(values) == 0 {
		return nil
	}
...
func (s sysAdminDo) First() (*rpc_sys_model.SysAdmin, error) {
	if result, err := s.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*rpc_sys_model.SysAdmin), nil
	}
}

func (s sysAdminDo) Take() (*rpc_sys_model.SysAdmin, error) {
...
func (s sysAdminDo) Last() (*rpc_sys_model.SysAdmin, error) {
...
func (s sysAdminDo) Find() ([]*rpc_sys_model.SysAdmin, error) {
	result, err := s.DO.Find()
	return result.([]*rpc_sys_model.SysAdmin), err
}

func (s sysAdminDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*rpc_sys_model.SysAdmin, err error) {
	buf := make([]*rpc_sys_model.SysAdmin, 0, batchSize)
...
func (s sysAdminDo) FindInBatches(result *[]*rpc_sys_model.SysAdmin, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (s sysAdminDo) FirstOrInit() (*rpc_sys_model.SysAdmin, error) {
...
func (s sysAdminDo) FirstOrCreate() (*rpc_sys_model.SysAdmin, error) {
...
func (s sysAdminDo) FindByPage(offset int, limit int) (result []*rpc_sys_model.SysAdmin, count int64, err error) {
...
func (s sysAdminDo) Delete(models ...*rpc_sys_model.SysAdmin) (result gen.ResultInfo, err error) {
