...
func newSysRole(db *gorm.DB, opts ...gen.DOOption) sysRole {
	...
	_sysRole.sysRoleDo.UseModel(&rpc_sys_model.SysRole{})
...
func (s sysRoleDo) Create(values ...*rpc_sys_model.SysRole) error {
	if len(values) == 0 {
		return nil
	}
...
func (s sysRoleDo) CreateInBatches(values []*rpc_sys_model.SysRole, batchSize int) error {
	return s.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (s sysRoleDo) Save(values ...*rpc_sys_model.SysRole) error {
	if len(values) == 0 {
		return nil
	}
...
func (s sysRoleDo) First() (*rpc_sys_model.SysRole, error) {
	if result, err := s.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*rpc_sys_model.SysRole), nil
	}
}

func (s sysRoleDo) Take() (*rpc_sys_model.SysRole, error) {
...
func (s sysRoleDo) Last() (*rpc_sys_model.SysRole, error) {
...
func (s sysRoleDo) Find() ([]*rpc_sys_model.SysRole, error) {
	result, err := s.DO.Find()
	return result.([]*rpc_sys_model.SysRole), err
}

func (s sysRoleDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*rpc_sys_model.SysRole, err error) {
	buf := make([]*rpc_sys_model.SysRole, 0, batchSize)
...
func (s sysRoleDo) FindInBatches(result *[]*rpc_sys_model.SysRole, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (s sysRoleDo) FirstOrInit() (*rpc_sys_model.SysRole, error) {
...
func (s sysRoleDo) FirstOrCreate() (*rpc_sys_model.SysRole, error) {
...
func (s sysRoleDo) FindByPage(offset int, limit int) (result []*rpc_sys_model.SysRole, count int64, err error) {
...
func (s sysRoleDo) Delete(models ...*rpc_sys_model.SysRole) (result gen.ResultInfo, err error) {
