...
func newSysAPI(db *gorm.DB, opts ...gen.DOOption) sysAPI {
	...
	_sysAPI.sysAPIDo.UseModel(&fkratos_sys_model.SysAPI{})
...
func (s sysAPIDo) Create(values ...*fkratos_sys_model.SysAPI) error {
	if len(values) == 0 {
		return nil
	}
...
func (s sysAPIDo) CreateInBatches(values []*fkratos_sys_model.SysAPI, batchSize int) error {
	return s.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (s sysAPIDo) Save(values ...*fkratos_sys_model.SysAPI) error {
	if len(values) == 0 {
		return nil
	}
...
func (s sysAPIDo) First() (*fkratos_sys_model.SysAPI, error) {
	if result, err := s.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*fkratos_sys_model.SysAPI), nil
	}
}

func (s sysAPIDo) Take() (*fkratos_sys_model.SysAPI, error) {
...
func (s sysAPIDo) Last() (*fkratos_sys_model.SysAPI, error) {
...
func (s sysAPIDo) Find() ([]*fkratos_sys_model.SysAPI, error) {
	result, err := s.DO.Find()
	return result.([]*fkratos_sys_model.SysAPI), err
}

func (s sysAPIDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*fkratos_sys_model.SysAPI, err error) {
	buf := make([]*fkratos_sys_model.SysAPI, 0, batchSize)
...
func (s sysAPIDo) FindInBatches(result *[]*fkratos_sys_model.SysAPI, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (s sysAPIDo) FirstOrInit() (*fkratos_sys_model.SysAPI, error) {
...
func (s sysAPIDo) FirstOrCreate() (*fkratos_sys_model.SysAPI, error) {
...
func (s sysAPIDo) FindByPage(offset int, limit int) (result []*fkratos_sys_model.SysAPI, count int64, err error) {
...
func (s sysAPIDo) Delete(models ...*fkratos_sys_model.SysAPI) (result gen.ResultInfo, err error) {
