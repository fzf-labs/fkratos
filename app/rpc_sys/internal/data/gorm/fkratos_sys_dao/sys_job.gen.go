...
func newSysJob(db *gorm.DB, opts ...gen.DOOption) sysJob {
	...
	_sysJob.sysJobDo.UseModel(&fkratos_sys_model.SysJob{})
...
func (s sysJobDo) Create(values ...*fkratos_sys_model.SysJob) error {
	if len(values) == 0 {
		return nil
	}
...
func (s sysJobDo) CreateInBatches(values []*fkratos_sys_model.SysJob, batchSize int) error {
	return s.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (s sysJobDo) Save(values ...*fkratos_sys_model.SysJob) error {
	if len(values) == 0 {
		return nil
	}
...
func (s sysJobDo) First() (*fkratos_sys_model.SysJob, error) {
	if result, err := s.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*fkratos_sys_model.SysJob), nil
	}
}

func (s sysJobDo) Take() (*fkratos_sys_model.SysJob, error) {
...
func (s sysJobDo) Last() (*fkratos_sys_model.SysJob, error) {
...
func (s sysJobDo) Find() ([]*fkratos_sys_model.SysJob, error) {
	result, err := s.DO.Find()
	return result.([]*fkratos_sys_model.SysJob), err
}

func (s sysJobDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*fkratos_sys_model.SysJob, err error) {
	buf := make([]*fkratos_sys_model.SysJob, 0, batchSize)
...
func (s sysJobDo) FindInBatches(result *[]*fkratos_sys_model.SysJob, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (s sysJobDo) FirstOrInit() (*fkratos_sys_model.SysJob, error) {
...
func (s sysJobDo) FirstOrCreate() (*fkratos_sys_model.SysJob, error) {
...
func (s sysJobDo) FindByPage(offset int, limit int) (result []*fkratos_sys_model.SysJob, count int64, err error) {
...
func (s sysJobDo) Delete(models ...*fkratos_sys_model.SysJob) (result gen.ResultInfo, err error) {
