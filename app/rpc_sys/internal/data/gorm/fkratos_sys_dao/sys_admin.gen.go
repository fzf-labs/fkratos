...
func newSysAdmin(db *gorm.DB, opts ...gen.DOOption) sysAdmin {
	...
	_sysAdmin.sysAdminDo.UseModel(&fkratos_sys_model.SysAdmin{})
...
func (s sysAdminDo) Create(values ...*fkratos_sys_model.SysAdmin) error {
	if len(values) == 0 {
		return nil
	}
...
func (s sysAdminDo) CreateInBatches(values []*fkratos_sys_model.SysAdmin, batchSize int) error {
	return s.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (s sysAdminDo) Save(values ...*fkratos_sys_model.SysAdmin) error {
	if len(values) == 0 {
		return nil
	}
...
func (s sysAdminDo) First() (*fkratos_sys_model.SysAdmin, error) {
	if result, err := s.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*fkratos_sys_model.SysAdmin), nil
	}
}

func (s sysAdminDo) Take() (*fkratos_sys_model.SysAdmin, error) {
...
func (s sysAdminDo) Last() (*fkratos_sys_model.SysAdmin, error) {
...
func (s sysAdminDo) Find() ([]*fkratos_sys_model.SysAdmin, error) {
	result, err := s.DO.Find()
	return result.([]*fkratos_sys_model.SysAdmin), err
}

func (s sysAdminDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*fkratos_sys_model.SysAdmin, err error) {
	buf := make([]*fkratos_sys_model.SysAdmin, 0, batchSize)
...
func (s sysAdminDo) FindInBatches(result *[]*fkratos_sys_model.SysAdmin, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (s sysAdminDo) FirstOrInit() (*fkratos_sys_model.SysAdmin, error) {
...
func (s sysAdminDo) FirstOrCreate() (*fkratos_sys_model.SysAdmin, error) {
...
func (s sysAdminDo) FindByPage(offset int, limit int) (result []*fkratos_sys_model.SysAdmin, count int64, err error) {
...
func (s sysAdminDo) Delete(models ...*fkratos_sys_model.SysAdmin) (result gen.ResultInfo, err error) {
