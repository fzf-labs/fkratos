...
func newSysDept(db *gorm.DB, opts ...gen.DOOption) sysDept {
	...
	_sysDept.sysDeptDo.UseModel(&fkratos_sys_model.SysDept{})
...
func (s sysDeptDo) Create(values ...*fkratos_sys_model.SysDept) error {
	if len(values) == 0 {
		return nil
	}
...
func (s sysDeptDo) CreateInBatches(values []*fkratos_sys_model.SysDept, batchSize int) error {
	return s.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (s sysDeptDo) Save(values ...*fkratos_sys_model.SysDept) error {
	if len(values) == 0 {
		return nil
	}
...
func (s sysDeptDo) First() (*fkratos_sys_model.SysDept, error) {
	if result, err := s.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*fkratos_sys_model.SysDept), nil
	}
}

func (s sysDeptDo) Take() (*fkratos_sys_model.SysDept, error) {
...
func (s sysDeptDo) Last() (*fkratos_sys_model.SysDept, error) {
...
func (s sysDeptDo) Find() ([]*fkratos_sys_model.SysDept, error) {
	result, err := s.DO.Find()
	return result.([]*fkratos_sys_model.SysDept), err
}

func (s sysDeptDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*fkratos_sys_model.SysDept, err error) {
	buf := make([]*fkratos_sys_model.SysDept, 0, batchSize)
...
func (s sysDeptDo) FindInBatches(result *[]*fkratos_sys_model.SysDept, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (s sysDeptDo) FirstOrInit() (*fkratos_sys_model.SysDept, error) {
...
func (s sysDeptDo) FirstOrCreate() (*fkratos_sys_model.SysDept, error) {
...
func (s sysDeptDo) FindByPage(offset int, limit int) (result []*fkratos_sys_model.SysDept, count int64, err error) {
...
func (s sysDeptDo) Delete(models ...*fkratos_sys_model.SysDept) (result gen.ResultInfo, err error) {
