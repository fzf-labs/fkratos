...
type Data_Redis struct {
	...
	DialTimeout  *durationpb.Duration `protobuf:"bytes,5,opt,name=dialTimeout,proto3" json:"dialTimeout,omitempty"`   // 连接超时时间
	ReadTimeout  *durationpb.Duration `protobuf:"bytes,6,opt,name=readTimeout,proto3" json:"readTimeout,omitempty"`   // 读取超时时间
	WriteTimeout *durationpb.Duration `protobuf:"bytes,7,opt,name=writeTimeout,proto3" json:"writeTimeout,omitempty"` // 写入超时时间
}
...
var file_data_proto_rawDesc = []byte{
	...
	0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xf2, 0x04, 0x0a,
	...
	0x63, 0x69, 0x6e, 0x67, 0x1a, 0x9a, 0x02, 0x0a, 0x05, 0x52, 0x65, 0x64, 0x69, 0x73, 0x12, 0x18,
