...
func init() {
	CmdService.Flags().StringVarP(&targetDir, "target-dir", "t", "internal/data", "generate target directory")
}

func run(_ *cobra.Command, args []string) {
	if len(args) == 0 {
		fmt.Fprintln(os.Stderr, "Please specify the proto file. Example: xxx proto data api/xxx.proto")
		return
	}
