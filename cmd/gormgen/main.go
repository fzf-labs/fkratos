...
func main() {
	...
	gen.NewGeneration(connectDB, "./internal/data/gorm", gen.WithDataMap(gen.DefaultPostgresDataMap), gen.WithOpts(gen.ModelOptionRemoveDefault(), gen.ModelOptionUnderline("UL"))).Do()
}
